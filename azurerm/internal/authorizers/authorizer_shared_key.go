...
// NewSharedKeyAuthorizer crates a SharedKeyAuthorizer using the given credentials
...
// computeSharedKey computes the Shared Key  required for Storage Authentication
